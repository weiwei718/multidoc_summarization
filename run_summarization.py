...
flags.DEFINE_string('data_root', 'tf_data',
                    'Path to root directory for all datasets (already converted to TensorFlow examples).')
flags.DEFINE_string('vocab_path', 'logs/vocab',
                    'Path expression to text vocabulary file.')
flags.DEFINE_string('pretrained_path', 'logs/pretrained_model_tf1.2.1',
                    'Directory of pretrained model from See et al.')
...
flags.DEFINE_string('dataset_split', 'test',
                    'Which dataset split to use. Must be one of {train, val, test}')
...
flags.DEFINE_integer('max_enc_steps', 100000,
...
flags.DEFINE_integer('min_dec_steps', 100,
...
flags.DEFINE_float('adagrad_init_acc', 0.1,
                   'initial accumulator value for Adagrad')
flags.DEFINE_float('rand_unif_init_mag', 0.02,
                   'magnitude for lstm cells random uniform inititalization')
flags.DEFINE_float('trunc_norm_init_std', 1e-4,
...
flags.DEFINE_boolean('pointer_gen', True,
